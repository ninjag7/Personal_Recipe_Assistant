...
class BreakfastDetailPage extends StatefulWidget {
  ...
  @override
  _BreakfastDetailPageState createState() => _BreakfastDetailPageState();
}

class _BreakfastDetailPageState extends State<BreakfastDetailPage> {
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: const Row(
                            ...
                            children: [
                              Text(
                                'Note : You can add extra ingredients \n \t\t\t\t\t\t according to your diets ',
